...
function openUpdateDialog() {
  ...
  const nodes = [
    ...
    admin && !u.can_install ? el('p', { class: 'form-error', text: tr('This installation cannot update itself (this build has no release key, or the program folder is not writable for the user DENIS runs as). Install the new version by hand') + (u.latest.page ? ': ' + u.latest.page : '.') }) : null,
